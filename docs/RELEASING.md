...
4. Merge only after review and green validation. The snapshot-path push on `main` verifies that it came from the catalog automation PR and creates the package Tag; the Tag publishes through OIDC and creates the GitHub release.
